...
Aplicação desenvolvida para praticar o que foi aprendido no React Native junto com o TypeScript, utilizando rotas, Async Storage e a Context API, seguindo os requisitos propostos logo abaixo pelo desafio 8 do bootcamp GoStack da Rocketseat.
